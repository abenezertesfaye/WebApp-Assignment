    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <!-- <a class="navbar-brand" href="./"><img src="../frontend/admin/images/logo.png" alt="Logo"></a> -->
                <!-- <a class="navbar-brand hidden" href="./"><img src="../frontend/admin/images/logo2.png" alt="Logo"></a> -->
            </div>
