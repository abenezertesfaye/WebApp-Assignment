...
include('Includes/db.php');
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `cadidates` (`candidate_name`,`description`) VALUES ('$candidate_name','$description')";
                                                            ...
                                                            <form action="add.php" method="post" class="">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="name" name="candidate_name" placeholder="Username" class="form-control" value= "<?php if(isset($_POST['candidate_name'])) echo $name; ?>" required>
                                                                    </div>
                                                                </div>
                                                                            <div class="col-12 col-md-9"><textarea name="description" id="textarea-input" rows="9" placeholder="candidates motto" class="form-control"
                                                                                value= "<?php if(isset($_POST['candidate_name'])) echo $name; ?>" required></textarea></div>
