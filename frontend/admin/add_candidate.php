            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="tables-basic.html">Add candidate</a></li>
                            <li><i class="fa fa-table"></i><a href="tables-data.html">Edit candidate</a></li>
                            <li><i class="fa fa-table"></i><a href="tables-data.html">Delete candidate</a></li>
                        </ul>
                    </li>
                                                            ...
                                                            <form action="" method="post" class="">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="Candidate Name" name="candidate_name" placeholder="Candidate Name" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-users"></i></div>
                                                                        <input type="text" id="discription" name="discription" placeholder="discription" class="form-control">
                                                                    </div>
                                                                </div>
